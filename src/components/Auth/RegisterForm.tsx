  ...
  return (
    <div className="card-3d-no-tilt max-w-md mx-auto">
      <div className="text-center mb-8">
        <div className="p-3 bg-gradient-to-r from-green-500 to-blue-600 rounded-xl w-fit mx-auto mb-4">
          <UserPlus className="w-8 h-8 text-white" />
        </div>
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Create Account</h2>
        <p className="text-gray-600 dark:text-gray-300 mt-2">Start collecting feedback from your customers</p>
      </div>
